...
for (let i = 0; i < navBarTogglers.length; i++) {
    navBarTogglers[i].addEventListener("click", openNav)
}
...
const navBarClosers = document.querySelectorAll(".closebtn");

for (let i = 0; i < navBarClosers.length; i++) {
    navBarClosers[i].addEventListener("click", closeNav)
}
